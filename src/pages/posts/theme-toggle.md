...
`<html>` に付与されているクラスでボタンのアイコン表示を切り替えるようにした。

- `dark` クラスがあるとき: ダークモードアイコン
- `light` クラスがあるとき: ライトモードアイコン
- `dark` も `light` も無いとき: システム設定を使っていることを表すアイコン
